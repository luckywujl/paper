...
--
-- Dumping data for table `paper_category`
--

LOCK TABLES `paper_category` WRITE;
/*!40000 ALTER TABLE `paper_category` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `paper_category` ENABLE KEYS */;
UNLOCK TABLES;
