...
--
-- Table structure for table `paper_sms`
--

DROP TABLE IF EXISTS `paper_sms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paper_sms` (
...
--
-- Dumping data for table `paper_sms`
--

LOCK TABLES `paper_sms` WRITE;
/*!40000 ALTER TABLE `paper_sms` DISABLE KEYS */;
/*!40000 ALTER TABLE `paper_sms` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-03-08 22:29:37
