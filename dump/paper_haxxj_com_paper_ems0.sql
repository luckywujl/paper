...
--
-- Table structure for table `paper_ems`
--

DROP TABLE IF EXISTS `paper_ems`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paper_ems` (
...
--
-- Dumping data for table `paper_ems`
--

LOCK TABLES `paper_ems` WRITE;
/*!40000 ALTER TABLE `paper_ems` DISABLE KEYS */;
/*!40000 ALTER TABLE `paper_ems` ENABLE KEYS */;
UNLOCK TABLES;
