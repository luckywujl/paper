...
CREATE TABLE `paper_sale_main_temp` (
  ...
  PRIMARY KEY (`sale_id`)
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='临时销售主表';
...
INSERT INTO `paper_sale_main_temp` VALUES (34,'',1613952867,1,'淮安兴彩包装有限公司','淮安市洪泽区高良涧','13861578182','吴俊雷',0,0,0,0,'','富盛纸业','','2'),(62,'',1614014655,1,'淮安兴彩包装有限公司','淮安市洪泽区高良涧','13861578182','吴俊雷',1,1200,3,3600,'张三','Admin','','1');
