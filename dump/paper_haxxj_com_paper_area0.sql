...
--
-- Table structure for table `paper_area`
--

DROP TABLE IF EXISTS `paper_area`;
...
--
-- Dumping data for table `paper_area`
--

LOCK TABLES `paper_area` WRITE;
/*!40000 ALTER TABLE `paper_area` DISABLE KEYS */;
/*!40000 ALTER TABLE `paper_area` ENABLE KEYS */;
UNLOCK TABLES;
